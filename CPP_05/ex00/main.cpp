...
/*   Updated: 2026/06/08 15:13:44 by rcompain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void )
{
	...
	std::cout << YELLOW << "Test 2 : grade too high in constructor" << RESET << std::endl;
	{
		try
		{
			Bureaucrat c("Carl", 0);
	...
	std::cout << YELLOW << "Test 3 : grade too low in constructor" << RESET << std::endl;
	{
		try
		{
